    ...
    return ListTile(
      ...
      leading: Stack(
        ...
        children: [
          ...
          Text(
            '${suraModel.index + 1}',
            style: IslamiStyles.body.copyWith(color: IslamiColors.white, fontSize: 16),
          ),
        ],
      ),
      title: Text(
        suraModel.nameEn,
        style: IslamiStyles.body.copyWith(color: IslamiColors.white),
      ),
      subtitle: Text(
      ...
      trailing: Text(
        suraModel.nameAr,
        style: IslamiStyles.title.copyWith(color: IslamiColors.white),
      ),
    );
  }
}
