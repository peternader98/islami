...
class _IntroScreenState extends State<IntroScreen> {
  ...
  Widget build(BuildContext context) {
    return IntroductionScreen(
      skip: Text('Skip', style: IslamiStyles.body.copyWith(fontSize: 16)),
      back: Text('Back', style: IslamiStyles.body.copyWith(fontSize: 16)),
      next: Text('Next', style: IslamiStyles.body.copyWith(fontSize: 16)),
      done: Text('Done', style: IslamiStyles.body.copyWith(fontSize: 16)),
      showSkipButton: true,
      showBackButton: true,
      showNextButton: true,
      showDoneButton: true,
      onSkip: () async {
        await CacheHelper.saveBool('intro_screen', true);
